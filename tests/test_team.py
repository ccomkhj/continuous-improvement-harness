...
def _green_verifier(**kwargs):
    return TddVerdict(
        eligible=True, passed=True, red_failed=True, green_passed=True, full_suite_passed=True
    )
